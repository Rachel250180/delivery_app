...
## 開発背景
特に、経験の浅い配達員や初めて担当する地域では、効率的な道順が分からず、道に迷ったり遠回りをしたりすることがあります。一方で、経験を積んだ配達員は、実際の配達を通して「この道を通った方が早い」「この順番で回った方が効率的」といったルートの知識を持っています。

しかし、こうした知識は個人の経験として蓄積されやすく、他の配達員へ共有しにくいという問題がありました。

そこで、経験のある配達員が実際に使用している効率的なルートを登録し、他の配達員も簡単に確認・利用できる仕組みがあれば、経験の差による配達効率のばらつきを減らせるのではないかと考えました。

この課題を技術によって解決するため、配達ルートを地図上で登録・管理し、必要なときに検索・確認できるWebアプリケーション「Delivery Catchup」を開発しました。
